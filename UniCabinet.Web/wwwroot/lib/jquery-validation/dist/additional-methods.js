...
$.validator.addMethod( "cifES", function( value, element ) {
	...
	control_digit = (10 - (all_sum).toString().substring((all_sum).toString().length - 1)).toString();
	control_digit = parseInt(control_digit, 10) > 9 ? "0" : control_digit;
	control_letter = "JABCDEFGHI".substring(control_digit, parseInt(control_digit, 10) + 1).toString();
